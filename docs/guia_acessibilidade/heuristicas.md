...
- [ ] O usuário deve sempre ter uma "saída de emergência" clara para abandonar uma ação indesejada, sem precisar passar por um processo extenso. [Heurística de Nielsen nº 3 — Controle do Usuário e Liberdade]
...
- [ ] É preferível eliminar condições propensas a erro ou alertar o usuário com uma confirmação antes que ele cometa uma ação problemática, em vez de apenas exibir uma boa mensagem de erro depois do fato. [Heurística de Nielsen nº 5 — Prevenção de Erros]
...
- [ ] Atalhos — muitas vezes ocultos de usuários novatos — podem acelerar a interação para usuários experientes, permitindo que a interface atenda simultaneamente a perfis distintos. [Heurística de Nielsen nº 7 — Flexibilidade e Eficiência de Uso]
...
- [ ] Idealmente, o sistema deve ser utilizável sem necessidade de explicações adicionais; quando a documentação for necessária, ela deve ser breve, objetiva e focada na tarefa do usuário. [Heurística de Nielsen nº 10 — Ajuda e Documentação]
...
NIELSEN, Jakob. **10 Usability Heuristics for User Interface Design**. Nielsen Norman Group, 1994. Atualizado em 30 jan. 2024. Disponível em: <https://www.nngroup.com/articles/ten-usability-heuristics/>. Acesso em: 28 jun. 2026.

PROGRAMA DE COOPERAÇÃO ENTRE REINO UNIDO E BRASIL EM ACESSO DIGITAL. **Guia de Boas Práticas para Acessibilidade Digital**. Secretaria de Governo Digital (SGD/MGI); Ceweb.br/NIC.br; Movimento Web para Todos, 2023. Disponível em: <https://www.gov.br/governodigital/pt-br/acessibilidade-e-usuario/acessibilidade-digital/guiaboaspraaticasparaacessibilidadedigital.pdf>. Acesso em: 28 jun. 2026.